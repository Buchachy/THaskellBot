// ==UserScript==
// @name        THaskelLauncher
// @namespace   THaskelLauncher
// @include     http://agar.io/*
// @version     3.063
// @grant       none
// @author      http://www.youtube.com/c/THaskellGaming
// ==/UserScript==
...
(function(d, e) {
    ...
    function gb() {
        ...
        var displayText = 'Счёт: ' + ~~(R / 100) + " Продержался: " + nbSeconds + " секунд.";
    ...
    function drawStats(d) {
        ...
        var debugStrings = [];
        debugStrings.push("Чит: " + window.botList[botIndex][0]);
        debugStrings.push("T - Бот: " + (!toggle ? "ВКЛ" : "ВыКл"));
        debugStrings.push("R - Линии: " + (!toggleDraw ? "ВКЛ" : "ВыКл"));
        debugStrings.push("Q - Следовать за мышкой: " + (toggleFollow ? "ВКЛ" : "ВыКл"));
        debugStrings.push("");
        debugStrings.push("Лучший размер: " + ~~(sessionScore / 100));
        debugStrings.push("Продержался: " + bestTime + " секунд");
