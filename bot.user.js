...
console.log("Running THaskell Bot!");
(function(f, g) {
    var splitDistance = 710;
    console.log("THaskell Bot!");
    ...
    f.botList.push(["THaskellBot " + aposBotVersion, findDestination]);

    var bList = g('#bList');
    g('<option />', {value: (f.botList.length - 1), text: "THaskellBot"}).appendTo(bList);
